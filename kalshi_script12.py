...
def compute_trade_analytics(trades_df):
    ...
    analytics = trades_df.groupby('market_ticker').agg(
        ...
        min_trade_count=('count', 'min'),
        max_trade_count=('count', 'max'),
        mean_trade_count=('count', 'mean'),
        median_trade_count=('count', 'median'),
        std_trade_count=('count', 'std'),
        weighted_yes_price=('yes_weighted', 'sum'),
        weighted_no_price=('no_weighted', 'sum'),
        min_yes_price=('yes_price', 'min'),
        max_yes_price=('yes_price', 'max'),
        min_no_price=('no_price', 'min'),
        max_no_price=('no_price', 'max'),
    ...
    analytics['average_yes_price'] = analytics['weighted_yes_price'] / analytics['total_volume']
    analytics['average_no_price'] = analytics['weighted_no_price'] / analytics['total_volume']
    analytics['average_trade_size'] = analytics['total_volume'] / analytics['num_trades']

    # Drop intermediate columns if desired
    analytics = analytics.drop(columns=['weighted_yes_price', 'weighted_no_price'])
...
def main():
    series_tickers = ['KXNBAGAME', 'KXNBASERIES', 'KXNBA', 'KXNBAEAST', 'KXNBAWEST']
